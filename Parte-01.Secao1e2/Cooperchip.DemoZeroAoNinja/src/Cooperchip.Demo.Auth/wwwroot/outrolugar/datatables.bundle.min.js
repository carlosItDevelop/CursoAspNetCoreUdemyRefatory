 ...
 */
(function(n){typeof define=="function"&&define.amd?define(["jquery","datatables.net"],function(t){return n(t,window,document)}):typeof exports=="object"?module.exports=function(t,i){return t||(t=window),i&&i.fn.dataTable||(i=require("datatables.net")(t,i).$),n(i,t,t.document)}:n(jQuery,window,document)})(function(n){"use strict";var i=n.fn.dataTable,t="css_right ui-icon ui-icon-",r="fg-toolbar ui-toolbar ui-widget-header ui-helper-clearfix ui-corner-";return n.extend(!0,i.defaults,{dom:'<"'+r+'tl ui-corner-tr"lfr>t<"'+r+'bl ui-corner-br"ip>',renderer:"jqueryui"}),n.extend(i.ext.classes,{sWrapper:"dataTables_wrapper dt-jqueryui",sPageButton:"fg-button ui-button ui-state-default",sPageButtonActive:"ui-state-disabled",sPageButtonDisabled:"ui-state-disabled",sPaging:"dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-multi paging_",sSortAsc:"ui-state-default sorting_asc",sSortDesc:"ui-state-default sorting_desc",sSortable:"ui-state-default sorting",sSortableAsc:"ui-state-default sorting_asc_disabled",sSortableDesc:"ui-state-default sorting_desc_disabled",sSortableNone:"ui-state-default sorting_disabled",sSortIcon:"DataTables_sort_icon",sScrollHead:"dataTables_scrollHead ui-state-default",sScrollFoot:"dataTables_scrollFoot ui-state-default",sHeaderTH:"ui-state-default",sFooterTH:"ui-state-default"}),i.ext.renderer.header.jqueryui=function(i,r,u,f){var e=t+"caret-2-n-s",o=n.inArray("asc",u.asSorting)!==-1,s=n.inArray("desc",u.asSorting)!==-1;u.bSortable&&(o||s)?o&&!s?e=t+"caret-1-n":!o&&s&&(e=t+"caret-1-s"):e="";n("<div/>").addClass("DataTables_sort_wrapper").append(r.contents()).append(n("<span/>").addClass(f.sSortIcon+" "+e)).appendTo(r);n(i.nTable).on("order.dt",function(n,o,s,h){if(i===o){var c=u.idx;r.removeClass(f.sSortAsc+" "+f.sSortDesc).addClass(h[c]=="asc"?f.sSortAsc:h[c]=="desc"?f.sSortDesc:u.sSortingClass);r.find("span."+f.sSortIcon).removeClass(t+"triangle-1-n "+t+"triangle-1-s "+t+"caret-2-n-s "+t+"caret-1-n "+t+"caret-1-s").addClass(h[c]=="asc"?t+"triangle-1-n":h[c]=="desc"?t+"triangle-1-s":e)}})},i.TableTools&&n.extend(!0,i.TableTools.classes,{container:"DTTT_container ui-buttonset ui-buttonset-multi",buttons:{normal:"DTTT_button ui-button ui-state-default"},collection:{container:"DTTT_collection ui-buttonset ui-buttonset-multi"}}),i});
/*! DataTables UIkit 3 integration
 */
(function(n){typeof define=="function"&&define.amd?define(["jquery","datatables.net"],function(t){return n(t,window,document)}):typeof exports=="object"?module.exports=function(t,i){return t||(t=window),i&&i.fn.dataTable||(i=require("datatables.net")(t,i).$),n(i,t,t.document)}:n(jQuery,window,document)})(function(n,t,i){"use strict";var r=n.fn.dataTable;return n.extend(!0,r.defaults,{dom:"<'row uk-grid'<'uk-width-1-2'l><'uk-width-1-2'f>><'row uk-grid dt-merge-grid'<'uk-width-1-1'tr>><'row uk-grid dt-merge-grid'<'uk-width-2-5'i><'uk-width-3-5'p>>",renderer:"uikit"}),n.extend(r.ext.classes,{sWrapper:"dataTables_wrapper uk-form dt-uikit",sFilterInput:"uk-form-small uk-input",sLengthSelect:"uk-form-small uk-select",sProcessing:"dataTables_processing uk-panel"}),r.ext.renderer.pageButton.uikit=function(t,u,f,e,o,s){var v=new r.Api(t),w=t.oClasses,l=t.oLanguage.oPaginate,b=t.oLanguage.oAria.paginate||{},c,h,y=0,p=function(i,r){for(var k,u,d=function(t){t.preventDefault();n(t.currentTarget).hasClass("disabled")||v.page()==t.data.action||v.page(t.data.action).draw("page")},e=0,a=r.length;e<a;e++)if(u=r[e],n.isArray(u))p(i,u);else{c="";h="";switch(u){case"ellipsis":c='<i class="uk-icon-ellipsis-h"><\/i>';h="uk-disabled disabled";break;case"first":c='<i class="uk-icon-angle-double-left"><\/i> '+l.sFirst;h=o>0?"":" uk-disabled disabled";break;case"previous":c='<i class="uk-icon-angle-left"><\/i> '+l.sPrevious;h=o>0?"":"uk-disabled disabled";break;case"next":c=l.sNext+' <i class="uk-icon-angle-right"><\/i>';h=o<s-1?"":"uk-disabled disabled";break;case"last":c=l.sLast+' <i class="uk-icon-angle-double-right"><\/i>';h=o<s-1?"":" uk-disabled disabled";break;default:c=u+1;h=o===u?"uk-active":""}c&&(k=n("<li>",{"class":w.sPageButton+" "+h,id:f===0&&typeof u=="string"?t.sTableId+"_"+u:null}).append(n(-1!=h.indexOf("disabled")||-1!=h.indexOf("active")?"<span>":"<a>",{href:"#","aria-controls":t.sTableId,"aria-label":b[u],"data-dt-idx":y,tabindex:t.iTabIndex}).html(c)).appendTo(i),t.oApi._fnBindAction(k,{action:u},d),y++)}},a;try{a=n(u).find(i.activeElement).data("dt-idx")}catch(k){}p(n(u).empty().html('<ul class="uk-pagination uk-pagination-right uk-flex-right"/>').children("ul"),e);a&&n(u).find("[data-dt-idx="+a+"]").trigger("focus")},r});
/*! DataTables 1.10.21
